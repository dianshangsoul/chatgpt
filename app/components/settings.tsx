...
export function Settings() {
  ...
  const getExpire = () => {
    axios({
      method: "get",
      url: "https://test.dianshangsoul.com/user/getexpire",
      withCredentials: true,
    }).then((res) => {
  ...
  const getCurrentNumber = () => {
    axios({
      method: "get",
      url: "https://test.dianshangsoul.com/user/getCurrentNumber",
      withCredentials: true,
    }).then((res) => {
  ...
  const goLogin = () => {
    if (localStorage.getItem("userInfo")) {
      axios({
        method: "get",
        url: "https://test.dianshangsoul.com/common/logout",
        withCredentials: true,
      }).then((res) => {
        if (res.data.code === 200) {
    ...
    <ErrorBoundary>
      ...
      <div className={styles["settings"]}>
        <List>
          ...
          <ListItem title={Locale.Settings.CurrentUser}>
